...
final class HistoryViewModel: ObservableObject {
    ...
    private let store = NottiHistoryStore.live
    ...
    func delete(_ ids: Set<UUID>) {
        ...
        try? NottiConversationRepository.live.deleteFromHistory(ids)
    }
...
#Preview {
    NottiHistoryView(onSelect: { _ in })
}
