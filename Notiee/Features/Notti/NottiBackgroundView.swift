...
// MARK: - Notti Background View (V3: fixed animation math, slower, proper keyboard positioning)

struct NottiBackgroundView: View {
    let state: NottiState
...
#Preview {
    NottiBackgroundView(state: .idle, isInputFocused: false, keyboardHeight: 0)
